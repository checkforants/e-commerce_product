...
const Navigator = (props:any) => {
	...
	return (
		<div className='navigator fixed w-4/5 h-[90px] mx-auto pt-2 flex flex-row justify-between border-b-2 box-border pt-5 bg-white'>
			<div className='flex flex-row space-x-12 mt-5'>
				...
				<div className='titles flex flex-row space-x-8'>
					...
					<Link className='menu_item pb-8 box-border' to="/newItem">CreateItem</Link>
				</div>
			</div>
			<div className='flex flex-row space-x-4 mt-6'>
				{/* <Plus></Plus> */}
				<div className='relative' onMouseEnter={()=>setCart(true)} onMouseLeave={()=>setCart(false)}>
				...
				<img className='w-[45px] h-[45px] relative bottom-[12px] avatar' src={props.image} alt="ava" />
			</div>
		</div>
	);
};
